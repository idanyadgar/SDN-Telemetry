...
class ByteCount(app_manager.RyuApp):
    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]

    def __init__(self, *args, **kwargs):
        super(ByteCount, self).__init__(*args, **kwargs)
        self.mac_to_port = {}
        # new-22.1
    ...
    def flow_removed_handler(self, ev):
        ...
        print "In the last %d seconds we saw %d bytes in switch %d" % (msg.duration_sec, msg.byte_count, dp.id)
